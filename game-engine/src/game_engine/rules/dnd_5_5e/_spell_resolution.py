...
def cast_spell(
    ...
    for target_id in target_ids:
        ...
        # 2024 PHB: Dodge gives disadvantage on attacks against the target and
        # advantage on the target's DEX saves, as long as they can act.
        ...
        if spell.attack_roll:
            ...
            dex_advantage = target_dodging and spell.save is Ability.DEXTERITY
            save = _roll_saving_throw_impl(target, spell.save, dc, advantage=dex_advantage)
