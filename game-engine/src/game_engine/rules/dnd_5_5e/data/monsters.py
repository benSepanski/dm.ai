...
MONSTERS: list[MonsterData] = [
    ...
    MonsterData(
        ...
        actions=[
            MonsterAction(
                "Slam", 3, DiceNotation("1d6+1"), DamageType.BLUDGEONING, 5, "Melee weapon attack."
            ),
        ],
        special_traits=[
            "Undead Fortitude: On being reduced to 0 HP, makes a Constitution save (DC = 5 + damage taken). On success it drops to 1 HP instead."
        ],
        legendary_actions=[],
    ),
    MonsterData(
    ...
    MonsterData(
        ...
        special_traits=[
            "Aggressive: As a bonus action, move up to speed toward a hostile creature."
        ],
        legendary_actions=[],
    ),
    # CR 1 ────────────────────────────────────────────────────────────────────
    ...
    MonsterData(
        ...
        special_traits=[
            "Brute: A melee weapon hit deals one extra die of damage (included above).",
    ...
    MonsterData(
        ...
        actions=[
            MonsterAction(
                "Bite", 5, DiceNotation("1d8+3"), DamageType.PIERCING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Claw", 5, DiceNotation("2d6+3"), DamageType.SLASHING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Tail Spike",
                5,
        ...
        special_traits=[
            "Tail Spike Regrowth: Has 24 tail spikes; used spikes regrow when it finishes a long rest."
        ],
        legendary_actions=[],
    ),
    MonsterData(
        ...
        special_traits=[
            "Petrifying Gaze: Creatures that start their turn within 30 ft and can see the basilisk's eyes must make a DC 12 Constitution save or begin petrifying (petrified on second failure)."
        ],
        legendary_actions=[],
    ),
    MonsterData(
        ...
        actions=[
            ...
            MonsterAction(
                "Beak", 7, DiceNotation("1d10+5"), DamageType.PIERCING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Claws", 7, DiceNotation("2d8+5"), DamageType.SLASHING, 5, "Melee weapon attack."
            ),
        ],
        special_traits=[
    ...
    MonsterData(
        ...
        special_traits=[
            "Detect Life: Can sense the life force of creatures within 5 miles.",
    ...
    MonsterData(
        ...
        actions=[
            ...
            MonsterAction(
                "Bite", 7, DiceNotation("1d6+4"), DamageType.PIERCING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Claw", 7, DiceNotation("2d6+4"), DamageType.SLASHING, 5, "Melee weapon attack."
            ),
        ],
        special_traits=[
    ...
    MonsterData(
        ...
        actions=[
            ...
            MonsterAction(
                "Bite", 7, DiceNotation("2d6+4"), DamageType.PIERCING, 10, "Melee weapon attack."
            ),
            MonsterAction(
                "Claw", 7, DiceNotation("2d8+4"), DamageType.SLASHING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Stinger",
                7,
    ...
    MonsterData(
        ...
        actions=[
            ...
            MonsterAction(
                "Claw", 10, DiceNotation("2d6+6"), DamageType.SLASHING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Fire Breath",
                None,
        ...
        special_traits=[
            "Frightful Presence: Creatures within 120 ft aware of the dragon make DC 16 Wisdom save or are frightened for 1 minute."
        ],
        legendary_actions=[],
    ),
    MonsterData(
        ...
        special_traits=[
            "Legendary Resistance (3/Day): If it fails a save, it can choose to succeed instead.",
    ...
    MonsterData(
        ...
        actions=[
            MonsterAction(
                "Bite", 5, DiceNotation("4d6"), DamageType.PIERCING, 5, "Melee weapon attack."
            ),
            MonsterAction(
                "Eye Rays",
                None,
        ...
        special_traits=[
            "Antimagic Cone: Central eye creates a 150-ft cone; magic is suppressed in the cone.",
            "Legendary Resistance (3/Day): May choose to succeed on a failed save.",
        ],
        legendary_actions=[
            "Eye Ray: Use one random eye ray.",
