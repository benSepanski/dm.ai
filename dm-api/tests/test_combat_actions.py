"""Tests for combat action submission, turn advancement, and action economy.

Split from ``test_combat.py`` (file-length guideline); lifecycle and
initiative tests live in ``test_combat_lifecycle.py``.
"""
